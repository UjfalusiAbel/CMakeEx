...
// void Movement::move_forward(gpiod_line* l1, gpiod_line* l2, gpiod_line* r1, gpiod_line* r2)
// {
...
// void Movement::turn_left(int x, gpiod_line* l1, gpiod_line* l2, gpiod_line* r1, gpiod_line* r2)
// {
//     gpiod_line_set_value(l1, 1);
//     gpiod_line_set_value(l2, 0);
...
// void Movement::turn_right(int x, gpiod_line* l1, gpiod_line* l2, gpiod_line* r1, gpiod_line* r2)
// {
//     gpiod_line_set_value(l1, 0);
...
//     gpiod_line* l1 = gpiod_chip_get_line(chip, LEFT_IN1);
//     gpiod_line* l2 = gpiod_chip_get_line(chip, LEFT_IN2);
//     gpiod_line* r1 = gpiod_chip_get_line(chip, RIGHT_IN1);
//     gpiod_line* r2 = gpiod_chip_get_line(chip, RIGHT_IN2);
